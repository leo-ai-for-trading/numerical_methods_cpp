...
using namespace std;
/*
Here PriceTree is an object of BinLattice<double> class, 
to all ends and purposes equivalent to the BinLattice
class from List-ing 3.6. Similarly, StoppingTree is an object of BinLattice<bool> class.
*/
...
int Call::GetInputData()
{
    ...
    cout << "Enter steps to expiry N: "; cin >> N;
    SetN(N);
    cout << "Enter strike price K: "; cout << endl;
    return 0;
}
